...
#     geo_usa = geopandas.read_file(os.path.join(cwd, 'Data\cb_2018_us_county_500k\cb_2018_us_county_500k.shp'))
...
def state_map():
    ...
    # Load the shape file using geopandas
    geo_usa = geopandas.read_file(os.path.join(cwd, 'Data\cb_2018_us_state_500k\cb_2018_us_state_500k.shp'), index_col=['STATEFP'], usecols=['geometry'])
